...
public class CreateAccountSelectClass {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("accountName")).sendKeys("Sofia Select");
		...
		String accName = driver.findElement(By.xpath("//span[text()='Sofia Select  (14453)']")).getText();
		System.out.println(accName);

		//Verify that the account is displayed correctly.
		if (accName.contains("Sofia")) {
			System.out.println("Account is displayed correctly");
		} 
		else {
